...
import projectCosts from "./handlers/project-costs.js";
...
export const API_ROUTES = [
  ...
  ["POST", "/api/project-costs", projectCosts],
  ["PATCH", "/api/project-costs", projectCosts],
  ["DELETE", "/api/project-costs", projectCosts],
