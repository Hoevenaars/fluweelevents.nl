...
import { calcVerkoopprijs, money, normalizeProjectCostInput } from "./project-calc.js";
...
function mapProjectCost(row) {
  ...
  return {
    ...
    bevestigdBetaald: Boolean(row.bevestigd_betaald ?? row.bevestigdBetaald),
...
export async function createProjectCost(projectId, input = {}) {
  ...
  if (supabase) {
    ...
    const { data, error } = await supabase.from("project_costs").insert({
      ...
      bevestigd_betaald: fields.bevestigdBetaald,
...
export async function updateProjectCost(id, updates = {}) {
  ...
  if (supabase) {
    ...
    const { data, error } = await supabase.from("project_costs").update({
      ...
      bevestigd_betaald: merged.bevestigdBetaald,
