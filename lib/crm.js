...
const DEFAULT_TEMPLATES = [
  { slug: "bevestiging", naam: "Bevestiging ontvangst", onderwerp: "Bedankt voor je aanvraag · Fluweel Events", inhoud: "Beste {{naam}},\n\nBedankt voor je bericht. We nemen snel contact op.\n\nFluweel Events" },
  { slug: "followup", naam: "Follow-up gesprek", onderwerp: "Vervolg op ons gesprek · Fluweel Events", inhoud: "Beste {{naam}},\n\nLeuk dat we hebben gesproken.\n\nFluweel Events" },
  { slug: "offerte", naam: "Offerte begeleiding", onderwerp: "Je offerte van Fluweel Events", inhoud: "Beste {{naam}},\n\nHierbij ontvang je onze offerte.\n\nFluweel Events" },
];
...
export async function updateLead(id, updates = {}) {
  ...
  db.leads[idx] = { ...db.leads[idx], ...updates, status: updates.status ? normalizeStatus(updates.status) : db.leads[idx].status };
...
export async function listTemplates() {
  ...
  return (await readLocalDb()).templates;
}
